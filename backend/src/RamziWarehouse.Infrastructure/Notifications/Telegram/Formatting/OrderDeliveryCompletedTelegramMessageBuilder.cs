    ...
    OrderDeliveryCompletedTelegramMessageBuilder
{
        ...
        string? deliveryNote)
    {
        ...
        builder.AppendLine("🚚 SİFARİŞ TƏHVİL VERİLDİ");
        builder.AppendLine();
        ...
        builder.AppendLine(
            $"Təhvil verən: {NormalizeInline(deliveredByFullName)}");

        builder.AppendLine(
            $"Təhvil tarixi: " +
            deliveredAtUtc.ToString(
        ...
        builder.AppendLine();
        builder.AppendLine("Təhvil verilən məhsullar:");
        ...
        builder.AppendLine();
        builder.AppendLine(
            $"Təhvil qeydi: {GetNote(deliveryNote)}");
